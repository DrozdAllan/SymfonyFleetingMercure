...
final class Version20210430211033 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user ADD mail VARCHAR(255) NOT NULL, ADD vip DATETIME DEFAULT NULL, ADD stripe VARCHAR(255) DEFAULT NULL, ADD notif TINYINT(1) DEFAULT NULL');
